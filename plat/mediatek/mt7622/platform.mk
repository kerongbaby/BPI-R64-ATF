...
HAVE_DRAM_SRC_FILE	:= 	$(shell test -f ${MTK_PLAT_SOC}/drivers/dram/dramc_calib.c && echo yes)
ifeq ($(HAVE_DRAM_SRC_FILE),yes)
...
DRAM_LIBS		:=	${MTK_PLAT_SOC}/drivers/dram/release/dramc_calib.o	\
				${MTK_PLAT_SOC}/drivers/dram/release/dramc_dqs_gw.o	\
...
include ${MTK_PLAT}/common/drivers/nandx/Nandx.mk
BROM_HEADER_TYPE	:=	snand
NAND_TYPE		?=	2k+64
ifeq ($(NMBM),1)
include lib/nmbm/nmbm.mk
BL2_SOURCES		+=	${MTK_PLAT_SOC}/bl2_boot_snand.c		\
				${NMBM_SOURCES}
CPPFLAGS		+=	-DNMBM=1
